...
public AddPuestoFrame(ConexionBD conexion, RH_Puesto puesto) {
        ...
        txfSalMin.setText(String.valueOf(this.puesto.getSalarioMinimo()));
        txfSalMax.setText(String.valueOf(this.puesto.getSalarioMaximo()));
        this.bandera = true;
    }
    /**
    ...
    private void initComponents() {
        ...
        txfSalMin = new javax.swing.JTextField();
        lbl_Mensaje = new javax.swing.JLabel();
        jLabel1 = new javax.swing.JLabel();
        txfSalMax = new javax.swing.JTextField();
        ...
        txfSalMin.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txfSalMinKeyReleased(evt);
            }
        });
        jPanel1.add(txfSalMin, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 270, 111, -1));
        ...
        txfSalMax.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txfSalMaxKeyReleased(evt);
            }
        });
        jPanel1.add(txfSalMax, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 320, 110, -1));
    ...
    private void btn_RealizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_RealizarActionPerformed
        ...
        nPuesto.setSalarioMinimo(Float.parseFloat(txfSalMin.getText().toUpperCase()));
        nPuesto.setSalarioMaximo(Float.parseFloat(txfSalMax.getText().toUpperCase()));
    ...
    private void txfSalMinKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txfSalMinKeyReleased
        verificarCampos();
    }//GEN-LAST:event_txfSalMinKeyReleased

    private void txfSalMaxKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txfSalMaxKeyReleased
       verificarCampos();
    }//GEN-LAST:event_txfSalMaxKeyReleased
public void verificarCampos() {
        if ("".equals(txf_Nombre.getText()) || "".equals(txfSalMin.getText()) || "".equals(txfSalMax.getText())) {
            btn_Realizar.setEnabled(false);
    ...
    private javax.swing.JTextField txfSalMax;
    private javax.swing.JTextField txfSalMin;
