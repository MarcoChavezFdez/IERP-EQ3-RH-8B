 ...
 * @author Marco Chavez
 */
public class FormasPagoFrame extends javax.swing.JFrame {
    ...
    public FormasPagoFrame(ConexionBD conexion) {
        initComponents();
         this.setLocationRelativeTo(null);
        this.conexion = conexion;

        FormaPagoDAO formaPago = new FormaPagoDAO(this.conexion);
        this.paginaActual = 1;
        this.paginaMaxima = formaPago.consultaPaginas();
        if(paginaActual+1<=paginaMaxima)
            btn_Siguiente.setEnabled(true);
        else
            btn_Siguiente.setEnabled(false);
        lbl_PaginaMaxima.setText(String.valueOf(this.paginaMaxima));
        ArrayList<RH_FormaPago> lista = formaPago.consultaFormasPagoVistaPaginada(paginaActual);
        llenarTabla(lista);
    }
    ...
    private void btn_AddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_AddActionPerformed
        AddFormaPagoFrame addFormaPago = new AddFormaPagoFrame(this.conexion);
        this.dispose();
        addFormaPago.setVisible(true);
        this.pack();
    ...
    private void txf_BusquedaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txf_BusquedaKeyReleased
        if ("".equals(txf_Busqueda.getText())) {
            ...
            FormaPagoDAO formasPago = new FormaPagoDAO(this.conexion);
            this.paginaActual = 1;
            ArrayList<RH_FormaPago> lista = formasPago.consultaFormasPagoVistaPaginada(this.paginaActual);
            this.paginaMaxima = formasPago.consultaPaginas();
            ...
            FormaPagoDAO formasPago = new FormaPagoDAO(this.conexion);
            this.paginaActual = 1;
            ArrayList<RH_FormaPago> lista = formasPago.consultaFormasPagoNombreVistaPaginada(txf_Busqueda.getText(), this.paginaActual);
            this.paginaMaxima = formasPago.consultaPaginasNombre(txf_Busqueda.getText());
            this.lbl_PaginaMaxima.setText(String.valueOf(paginaMaxima));
            this.lbl_PaginaActual.setText(String.valueOf(this.paginaActual));
            if (paginaMaxima == 0) {
    ...
    private void btn_ModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ModificarActionPerformed
        ...
        FormaPagoDAO DAO = new FormaPagoDAO(this.conexion);
        RH_FormaPago formaPago = new RH_FormaPago();
        formaPago = DAO.consultaFormaPagoId(idEstado);
        AddFormaPagoFrame modificarFormaPago = new AddFormaPagoFrame(this.conexion, formaPago);
        this.setVisible(false);
        modificarFormaPago.setVisible(true);
    ...
    private void btn_EliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_EliminarActionPerformed
        Integer idFormaPago = Integer.parseInt(tbl_Datos.getValueAt(tbl_Datos.getSelectedRow(), 0).toString());
        String nombre = tbl_Datos.getValueAt(tbl_Datos.getSelectedRow(), 1).toString();
        int reply = JOptionPane.showConfirmDialog(null, "Está seguro que desea eliminar la formma de pago'" + nombre + "'?", "Confirmar Cambio de estatus", JOptionPane.YES_NO_OPTION);
        if (reply == JOptionPane.YES_OPTION) {
            RH_FormaPago formaPago = new RH_FormaPago();
            FormaPagoDAO DAO = new FormaPagoDAO(this.conexion);
            formaPago = DAO.consultaFormaPagoId(idFormaPago);
            if (DAO.eliminacionLogica(formaPago)) {
                JOptionPane.showMessageDialog(null, "Forma de pago eliminada");
                this.paginaActual = 1;
                this.paginaMaxima = DAO.consultaPaginas();
                lbl_PaginaActual.setText(String.valueOf(this.paginaActual));
                lbl_PaginaMaxima.setText(String.valueOf(this.paginaMaxima));
                ArrayList<RH_FormaPago> lista = DAO.consultaFormasPagoVistaPaginada(paginaActual);
                llenarTabla(lista);
    ...
    private void btn_SiguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_SiguienteActionPerformed
        if ((paginaActual + 1) <= paginaMaxima) {
            ...
            if (this.banderaBusqueda) {
                lista = DAO.consultaFormasPagoNombreVistaPaginada(txf_Busqueda.getText(), paginaActual);
            } else {
                lista = DAO.consultaFormasPagoVistaPaginada(paginaActual);
            }
    ...
    private void llenarTabla(ArrayList<RH_FormaPago> lista) {
        String[] encabezado = {"IdFormaPago", "Nombre"};
        Object[][] datos = new Object[lista.size()][2];
        int ren = 0;
        for (RH_FormaPago s : lista) {
            datos[ren][0] = s.getIdFormaPago();
